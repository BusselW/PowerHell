...
# --- Configuratie voor Team: Verkeersborden ---

# Doelpad (waar het nieuwe bestand wordt geplaatst)
$destinationPath = "\\som.org.om.local@SSL\DavWWWRoot\sites\MulderT\Onderdelen\Beoordelen\Verkeersborden\SitePages\"

# Bronpad (waar het sjabloonbestand zich bevindt)
$sourcePath = "\\som.org.om.local@SSL\DavWWWRoot\sites\MulderT\Onderdelen\Beoordelen\Verkeersborden\SitePages\Sjabloon\"

# Naam van het sjabloonbestand
$templateFile = "SjabloonWM-Verkeersborden.aspx"

# Team naam voor in bestandsnaam en titel
$teamName = "Verkeersborden"

# --- SharePoint REST API Configuratie ---

# De $siteUrl moet verwijzen naar de subsite die de 'SitePages' bibliotheek bevat.
$siteUrl = "https://som.org.om.local/sites/MulderT/Onderdelen/Beoordelen/Verkeersborden"
