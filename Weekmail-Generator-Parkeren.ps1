...
# --- Configuratie voor Team: Parkeren ---

# Doelpad (waar het nieuwe bestand wordt geplaatst)
$destinationPath = "\\som.org.om.local@SSL\DavWWWRoot\sites\MulderT\Onderdelen\Beoordelen\Parkeren\SitePages\"

# Bronpad (waar het sjabloonbestand zich bevindt)
$sourcePath = "\\som.org.om.local@SSL\DavWWWRoot\sites\MulderT\Onderdelen\Beoordelen\Parkeren\SitePages\Sjabloon\"
...
$siteUrl = "https://som.org.om.local/sites/MulderT/Onderdelen/Beoordelen/Parkeren"
